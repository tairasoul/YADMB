declare const _default: ({
    ...
    callback: (interaction: import("oceanic.js").CommandInteraction<import("oceanic.js").AnyInteractionChannel | import("oceanic.js").Uncached>, resolvers: import("../client.js").ResolverInformation, guild: import("../client.js").Guild) => Promise<import("oceanic.js").Message<import("oceanic.js").AnyInteractionChannel | import("oceanic.js").Uncached> | undefined>;
} | {
    name: string;
    description: string;
    options: {
